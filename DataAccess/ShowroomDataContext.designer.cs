...
namespace Showroom.Models
{
    ...
    partial void InsertCatelogue(Catelogue instance);
    partial void UpdateCatelogue(Catelogue instance);
    partial void DeleteCatelogue(Catelogue instance);
    partial void InsertPropertySubCatelogue(PropertySubCatelogue instance);
    partial void UpdatePropertySubCatelogue(PropertySubCatelogue instance);
    partial void DeletePropertySubCatelogue(PropertySubCatelogue instance);
    ...
    partial void InsertNewsCatelogue(NewsCatelogue instance);
    partial void UpdateNewsCatelogue(NewsCatelogue instance);
    partial void DeleteNewsCatelogue(NewsCatelogue instance);
    ...
    partial void InsertPropertyCatelogue(PropertyCatelogue instance);
    partial void UpdatePropertyCatelogue(PropertyCatelogue instance);
    partial void DeletePropertyCatelogue(PropertyCatelogue instance);
    #endregion
		
		public ShowroomDataContext() : 
				base(global::Showroom.Models.Properties.Settings.Default.DataSourceConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Catelogue> Catelogues
		{
			get
			{
				return this.GetTable<Catelogue>();
			}
		}
		
		public System.Data.Linq.Table<PropertySubCatelogue> PropertySubCatelogues
		{
			get
			{
				return this.GetTable<PropertySubCatelogue>();
			}
		}
		...
		public System.Data.Linq.Table<NewsCatelogue> NewsCatelogues
		{
			get
			{
				return this.GetTable<NewsCatelogue>();
			}
		}
		...
		public System.Data.Linq.Table<PropertyCatelogue> PropertyCatelogues
		{
			get
			{
				return this.GetTable<PropertyCatelogue>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="sunrise_admin.Catelogue")]
	public partial class Catelogue : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnActflgChanged();
		...
		{
			this.SendPropertyChanging();
			entity.Catelogue = this;
		}
		
		private void detach_Products(Product entity)
		{
			this.SendPropertyChanging();
			entity.Catelogue = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="sunrise_admin.PropertySubCatelogue")]
	public partial class PropertySubCatelogue : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnActflgChanged();
		...
		{
			this.SendPropertyChanging();
			entity.PropertySubCatelogue = this;
		}
		
		private void detach_Properties(Property entity)
		{
			this.SendPropertyChanging();
			entity.PropertySubCatelogue = null;
		}
	}
	...
	public partial class New : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<NewsCatelogue> _NewsCatelogue;
    ...
    partial void OnCatelogueIdChanged();
		...
		public New()
		{
			this._NewsCatelogue = default(EntityRef<NewsCatelogue>);
			OnCreated();
		}
		...
		public NewsCatelogue NewsCatelogue
		{
			get
			{
			...
			set
			{
				NewsCatelogue previousValue = this._NewsCatelogue.Entity;
							...
							|| (this._NewsCatelogue.HasLoadedOrAssignedValue == false)))
				{
					...
					this.SendPropertyChanged("NewsCatelogue");
				}
			}
		}
	...
	public partial class NewsCatelogue : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnImageChanged();
		...
		{
			this.SendPropertyChanging();
			entity.NewsCatelogue = this;
		}
		
		private void detach_News(New entity)
		{
			this.SendPropertyChanging();
			entity.NewsCatelogue = null;
		}
	}
	...
	public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Catelogue> _Catelogue;
    ...
    partial void OnActflgChanged();
		...
		public Product()
		{
			...
			this._Catelogue = default(EntityRef<Catelogue>);
			OnCreated();
		}
		...
		public Catelogue Catelogue
		{
			...
			set
			{
				Catelogue previousValue = this._Catelogue.Entity;
				if (((previousValue != value) 
							|| (this._Catelogue.HasLoadedOrAssignedValue == false)))
				{
					...
					this.SendPropertyChanged("Catelogue");
				}
			}
		}
	...
	public partial class Property : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<PropertySubCatelogue> _PropertySubCatelogue;
		
		private EntityRef<PropertyCatelogue> _PropertyCatelogue;
    ...
    partial void OnActflgChanged();
		...
		{
			this._ProductProperties = new EntitySet<ProductProperty>(new Action<ProductProperty>(this.attach_ProductProperties), new Action<ProductProperty>(this.detach_ProductProperties));
			this._PropertySubCatelogue = default(EntityRef<PropertySubCatelogue>);
			this._PropertyCatelogue = default(EntityRef<PropertyCatelogue>);
			OnCreated();
		}
		...
		public PropertySubCatelogue PropertySubCatelogue
		{
			get
			{
			...
			set
			{
				PropertySubCatelogue previousValue = this._PropertySubCatelogue.Entity;
				if (((previousValue != value) 
							|| (this._PropertySubCatelogue.HasLoadedOrAssignedValue == false)))
				{
					...
					this.SendPropertyChanged("PropertySubCatelogue");
				}
			}
		}
		...
		public PropertyCatelogue PropertyCatelogue
		{
			get
			{
			...
			set
			{
				PropertyCatelogue previousValue = this._PropertyCatelogue.Entity;
				if (((previousValue != value) 
							|| (this._PropertyCatelogue.HasLoadedOrAssignedValue == false)))
				{
					...
					this.SendPropertyChanged("PropertyCatelogue");
				}
			}
		}
	...
	public partial class PropertyCatelogue : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnActflgChanged();
		...
		{
			this.SendPropertyChanging();
			entity.PropertyCatelogue = this;
		}
		
		private void detach_Properties(Property entity)
		{
			this.SendPropertyChanging();
			entity.PropertyCatelogue = null;
		}
	}
}
